            ...
            <div>
              ...
              <div className="flex gap-3 mb-6">
                {product.stock === 0 ? (
                  ...
                  /* Mode preview: checkout dimatikan, arahkan ke WhatsApp */
                  <a
                    href={`https://wa.me/6285101256123?text=${encodeURIComponent(`Halo, saya tertarik dengan ${product.name}. Apakah masih tersedia?`)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 flex items-center justify-center gap-2 py-4 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold rounded-xl transition-colors"
                  >
                ...
                {/* Beli Sekarang — langsung ke proses belanja dengan produk ini */}
                {product.stock > 0 && !CHECKOUT_DISABLED && (
                  <a
                    ...
                    title="Beli Sekarang — langsung checkout tanpa keranjang"
                  >
                    <Zap size={18} />
                    <span className="text-sm">Beli Sekarang</span>
                  </a>
                )}
                ...
                <a
                  href={`https://wa.me/?text=${encodeURIComponent(`Lihat ${product.name} di BeliSeken!\n${formatPrice(product.sellingPrice)}\nhttps://beliseken.com/product/${product.slug}`)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-14 h-14 border-2 border-brand-border rounded-xl flex items-center justify-center hover:border-[#25D366] hover:text-[#25D366] hover:bg-[#25D366]/10 transition-colors"
