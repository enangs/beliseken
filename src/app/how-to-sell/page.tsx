...
const steps = [
  {
    ...
    title: "Foto Barang",
    desc: "Ambil foto barang dari berbagai sudut (depan, sisi, belakang, detail)"
  },
  {
    step: "2",
    icon: (
    ...
    title: "Hubungi Kami",
    desc: "Kirim foto via WhatsApp ke 0851-0125-6123 beserta spesifikasi barang"
  },
  {
    step: "3",
    icon: (
    ...
    desc: "Setelah deal harga, kami jemput barang dan bayar langsung atau transfer"
  }
];
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {steps.map((item) => (
            <div key={item.step} className="text-center p-6 bg-white rounded-xl border border-brand-border">
              ...
              <div className="text-brand mb-3 flex justify-center">{item.icon}</div>
