...
const steps = [
  {
    ...
    title: "Pilih Produk",
    desc: "Jelajahi katalog kami dan pilih produk yang diinginkan"
  },
  {
    step: "2",
    icon: (
    ...
    title: "Hubungi Kami",
    desc: "Chat via WhatsApp untuk konfirmasi ketersediaan dan harga"
  },
  {
    step: "3",
    icon: (
    ...
    title: "Bayar",
    desc: "Lakukan pembayaran via transfer bank, e-wallet, atau QRIS"
  },
  {
    step: "4",
    icon: (
    ...
    title: "Terima Barang",
    desc: "Barang dikirim atau diambil langsung di toko kami"
  }
];
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {steps.map((item) => (
            <div key={item.step} className="text-center p-6 bg-white rounded-xl border border-brand-border">
              ...
              <div className="text-brand mb-2 flex justify-center">{item.icon}</div>
