  ...
  return (
    <section className="py-16 md:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-brand to-brand-dark rounded-3xl p-8 md:p-12 lg:p-16 animate-gradient relative overflow-hidden">
          {/* Decorative Elements */}
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            <p className="text-xl text-white/90 mb-8">
              ...
              dapatkan penawaran dalam 1 jam.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
              {[
                ...
                "Bayar langsung / transfer",
                "Gratis jemput barang Bekasi",
              ].map((benefit, i) => (
                <div
                  key={i}
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                ...
                className="px-8 py-4 bg-[#25D366] text-white font-bold rounded-xl hover:bg-[#20bd5a] transition-colors text-base shadow-lg flex items-center gap-2"
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
