...
const instagramPosts = [
  { id: 1, emoji: "💻", color: "from-blue-400/20 to-purple-400/20" },
  { id: 2, emoji: "📱", color: "from-green-400/20 to-emerald-400/20" },
  { id: 3, emoji: "🖥️", color: "from-purple-400/20 to-pink-400/20" },
  { id: 4, emoji: "🌐", color: "from-yellow-400/20 to-orange-400/20" },
  { id: 5, emoji: "⌨️", color: "from-red-400/20 to-rose-400/20" },
  { id: 6, emoji: "🔌", color: "from-indigo-400/20 to-blue-400/20" },
];
